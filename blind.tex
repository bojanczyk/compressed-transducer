...
\begin{enumerate}
    ...
    \end{align*}
    In the data constructors $\leftterm$ (resp., $\rightterm$), the other type $B$ (resp., $A$) is part of the syntax, since it cannot be inferred from the argument $M$. We also have  atomic programs for deconstructing data:
        \begin{align*}
