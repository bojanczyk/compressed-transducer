...
ML: TODO. Is there a good candidate? If not, we could state this as an open problem.
...
ML: TODO, Not sure whether we should include this.
...
ML: I think one could also allow partial functions, but  this would not introduce any new aspects with respect to compatibility with compression.
I added a footnote saying this.
...
ML: I wrote something before Definition 12, please check in particular the footnote on page 7.
...
ML: sone, I added this explanation.
...
ML: I added a footnote (see the comment in the paper) that hopefully clarifies this point.
...
ML: done, I added a sentence after the definition of the destructors
...
ML: As far as I understand, your idea is to take the k-fold product of the input structure and then
apply a 1-dimensional MSO interpretation (and not FO interpretation) to it. The question is whether
this yields the rectangular polyreg. functions.
