...
\paragraph*{A normal form.} We finish this section with slightly different characterization of the rectangular polyregular functions, which does not use the map combinator in the closure properties, only composition. 
