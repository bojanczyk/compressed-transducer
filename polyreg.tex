...
\begin{proof}
    ...
    \end{proof}
Claim~\ref{claim-infix} together with the fact that $v_n$ contains all infixes $b a^i \underline{a}$ for every $1 \le i \le 2^n $ immediately yields the lemma. 
\end{proof}
