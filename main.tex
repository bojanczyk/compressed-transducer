...
where Viterbi algorithms for decoding  
...
checking equality \cite{HirshfeldJM94,MehlhornSU94,Pla94}, pattern matching \cite{KRS95,Jez15}, and membership in regular languages \cite{}; see the survey \cite{Loh12survey} for further details.
